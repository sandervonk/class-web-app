...
describe("QueryProcessor", () => {
  ...
  test("should handle large power operations", () => {
    ...
    const response: string = QueryProcessor(query);
    expect(response).toBe(
      "1811409012448835817695946872822595329565921474166650482442465863106371938918423437434232557190729891182723319242399754877525328948139653232562706029585126861239091480988757",
    );
  });
});
